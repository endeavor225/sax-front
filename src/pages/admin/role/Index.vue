<template>
  <q-page padding>
    ...
    <div v-else>
      <div class="text-h3 text-dark q-pa-sm q-mb-sm q-mt-sm" style="margin-top: 20px"> {{ $t('list.role')}}</div>
...
import ListeItem from "components/admin/role/Item";
import AddItem from "components/admin/role/Add";
import Search from "components/admin/role/Search";
import qs from "qs";
